...
| الملف | المحتوى |
|---|---|
| [الفكرة والمشكلة والحل](docs/problem-and-solution.md) | لماذا وُجد المشروع، والبدائل التي رُفضت ولماذا |
| [البنية والمخططات](docs/architecture.md) | مخططات التدفق والطبقات وقواعد الاعتماد |
| [مرجع الواجهة والأصناف](docs/api-reference.md) | نقطة JSON، الأصناف العامة، رموز الأخطاء |
| [الإعدادات والتشغيل](docs/configuration.md) | متغيرات البيئة وسيناريوهات جاهزة واستكشاف الأخطاء |
